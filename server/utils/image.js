...
function uploadImage(folder, req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dUri = new datauri_1.default();
                    dUri.format(path_1.default.extname(req.file.originalname).toString(), req.file.buffer);
                    return [4 /*yield*/, cloudinary.v2.uploader.upload(dUri.content, { folder: folder })];
                case 1:
                    result = _a.sent();
